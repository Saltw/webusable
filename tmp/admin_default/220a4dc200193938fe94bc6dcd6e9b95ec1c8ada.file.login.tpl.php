<?php /* Smarty version Smarty-3.1.19, created on 2017-07-10 08:16:10
         compiled from "/var/www/html/webusable/public_html/admin/templates/default/login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1396833255963700a93d5e8-61281359%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '220a4dc200193938fe94bc6dcd6e9b95ec1c8ada' => 
    array (
      0 => '/var/www/html/webusable/public_html/admin/templates/default/login.tpl',
      1 => 1499642987,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1396833255963700a93d5e8-61281359',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5963700ab4c1c6_72712851',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5963700ab4c1c6_72712851')) {function content_5963700ab4c1c6_72712851($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/webusable/public_html/includes/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_ia_hooker')) include '/var/www/html/webusable/public_html/includes/smarty/intelli_plugins/function.ia_hooker.php';
?><!DOCTYPE html>
...
">
                            ...
                            <div class="checkbox">
                                <label><input type="checkbox" name="remember"<?php if (isset($_POST['remember'])) {?> checked<?php }?> tabindex="3"> <?php echo iaSmarty::lang(array('key'=>'remember_me'),$_smarty_tpl);?>
</label>
                            </div>
...
"<?php if ($_smarty_tpl->tpl_vars['code']->value==@constant('IA_LANGUAGE')) {?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['language']->value['title'];?>
                            ...
                            <?php }?>
                            <input type="submit" class="btn btn-primary" tabindex="5" value="<?php echo iaSmarty::lang(array('key'=>'login'),$_smarty_tpl);?>
">
